                ...
                >
                    ...
                    >
                        <Box
                            component="img"
                            alt="drug image"
                            src="http://127.0.0.1:8000/frontend/static/images/slider/slide6.jpeg"
                            sx={{
                                width: {
                                    lg: '70%',
                                    xl: '70%',
                ...
                >
                    <Box>
                        <Typography variant="h6">
                            Humulin 70/30 Injection 100Iu/Ml 1Vialx10ml
                        </Typography>
                        <Typography mt={1}>
                            Brand : <Link> Eli Lilly Pakistan (Pvt) Ltd.</Link>
                        </Typography>
                    </Box>
                    <Box
                        sx={{
